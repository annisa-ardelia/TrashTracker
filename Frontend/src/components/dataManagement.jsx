...
const DataManagement = () => {
  ...
  return (
    <div className="container mx-auto h-full w-full mb-48 bg-primary">
      <h1 className="font-poppins text-center text-[55px] justify-center mb-12 pt-28">
        <span className="text-gradient font-bold text-[55px]">Data Management</span><br />
      </h1>
      <h2 className="font-poppins text-center text-[20px] justify-center -mt-12 mb-12">
        <span className="text-white text-[20px] font-semibold">Edit Data Tempat Sampah</span>
      </h2>
